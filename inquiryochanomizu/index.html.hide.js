...
<html lang="ja">
    <head>
        <meta charset="utf-8">
        <title>ウィークリーセンター御茶ノ水お問い合わせフォーム | ウィークリーセンター</title>
...
<body id="acp-page">
        ...
        <div id="pagelist-wrap">
            <ol id="pagelist">
                ...
                <li>ウィークリーセンター御茶ノ水お問い合わせフォーム</li>
            </ol>
        <!-- END:pagelist-wrap -->
        </div>
        ...
        <div id="container-wrap">
            <div id="container">
                <main>
                    ...
                    <div class="tit-l">
                        <h2>ウィークリーセンター御茶ノ水お問い合わせフォーム</h2>
                    </div>
          <div class="containerbox">        
          
            
<p class="boxwrap1">必須項目と他の項目をご記入後、内容確認ボタンを押して下さい。<br>
【ご注意】 空室情報など、ご入居に関するご質問や、お急ぎのご回答はできません。</p>
            <div class="form reservationform">
                            <form method="post" action="./">
<input type="hidden" name="form" value="4" data-sp="" />
                                <input type="hidden" name="SET_FILE" value="/inquiryochanomizu/indexset.ini" />
...
<tr>
                                <th><span class="red">※</span>お名前</th>
                                  <td>
                                    <input type="text" name="mailform1" size="30" value="" class="fm-txt" >
                                  </td>
                                </tr>
<tr>
                                <th><span class="red">※</span>フリガナ</th>
                                  <td>
                                    <input type="text" name="mailform2" size="30" value="" class="fm-txt" >
                                  </td>
                                </tr>
<tr>
                                <th><span class="red">※</span>電話番号</th>
                                  <td>
                                    <input type="text" name="mailform3" size="30" value="" class="fm-txt" >
                                  </td>
                                </tr>
<tr>
                                <th><span class="red">※</span>メールアドレス</th>
                                  <td><input type="text" name="mailform4" size="30" class="fm-txt"></td>
                                </tr>
<tr class="form-add">
...
<!-- 
AxWrite('400179691001','ax171212222956171');
// -->
</script>
