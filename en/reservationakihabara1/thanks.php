...
<body id="acp-page">
    ...
    <div id="pagelist-wrap">
        <ol id="pagelist">
            ...
            <li>Reservation form: Weekly Center Akihabara Part 1</li>
        </ol>
        <!-- END:pagelist-wrap -->
    </div>
  ...
  <div id="container-wrap">
    <div id="container">
        <main>
            ...
            <div class="tit-l">
                <h2>Reservation form: Weekly Center Akihabara Part 1</h2>
            </div>
                    ...
                    <?php
                        if (!empty($_POST['your_submit'])){
                            ...
                            if($mailer->Send()) {
                                ...
                                $subject_user = 'Thank you for your inquiry.:weeklycenter Akihabara Part 1'; 
...
<script type="text/javascript">
    <!-- 
    AxWrite('400179691001','ax171212222957392');
// -->
</script>
<!-- WCNAXE -->
</body>
